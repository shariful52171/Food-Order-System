...
<div id="boxes">
  ...
  <div id="mask"></div>
		...
		<section class="order-box-head-area">
			<div class="container">
			<div class="row">
					<div class="top-text-box wow bounceIn" data-wow-delay=".1s" data-wow-duration="2s">
						<div class="section-heading recipe">
							<div class="blog_heading blog-text">
								<h2>Enjoy your Lunch with us</h2>
							</div>
						</div>
						
						<p>We deliver clean & hygienic food in your doorstep!</p>
					</div>
				</div>
			</div>
		</section>
			...
			<div class="container">
				<div class="row">
					<div class="order-food-box">
						<div class="col-md-4 wow zoomIn" data-wow-duration="2s">
							<div class="single-order-box">
								...
								<div class="food-image">
									...
									<div class="price-bold">TK. 65</br><span class="meal">/meal</span></div>
								</div>
								<div class="price-btn-box">
									<ul>
										<li class="price-text"><a href="" data-toggle="modal" data-target="#menu65">Week Menu</a></li>
										<li>
						...
						<!-- Modal -->
						<div id="menu65" class="modal fade" role="dialog">
							<div class="modal-dialog">
								<!-- Modal content-->
								<div class="modal-content full-menu-box">
									...
									<div class="modal-body">
										<div class="full-menu-card">
											<div class="full-menu-head">
												Mr.</br>
												<span class="bold-text">Executive</span></br>
												<span class="menu-price">65tK</span>
											</div>
											<div class="full-menu-chart">
												<table class="table table-responsive full-menu-table">
													<tr>
														<th>শনিবার</th>
														<td>সাদা ভাত + ডাল + সবজি/ ভর্তা + চিকেন কারি</td>
													</tr>
													<tr>
														<th>রবিবার</th>
														<td>সাদা ভাত + ডাল + সবজি/ ভর্তা + ফিস কারি</td>
													</tr>
													<tr>
														<th>সোমবার</th>
														<td>শাহী সবজি খিচুড়ি + স্পেশাল ডিম কারি + সালাদ</td>
													</tr>
													<tr>
														<th>মঙ্গলবার</th>
														<td>সাদা ভাত + ডাল + সবজি/ ভর্তা + চিকেন মাসালা</td>
													</tr>
													<tr>
														<th>বুধবার</th>
														<td>সাদা ভাত + ডাল + সবজি/ ভর্তা + ফিস ফ্রাই</td>
													</tr>
													<tr>
														<th>বৃহস্পতিবার</th>
														<td>শাহী মোরগ পোলাও + সালাদ </td>
													</tr>
												</table>
											</div>
											<div class="full-menu-order">
												<a class="order-now" href="form95.php">Order Now</a>
											</div>
										</div>
									</div>
								</div>
						...
						<div class="col-md-4 wow zoomIn" data-wow-duration="2s">
							<div class="single-order-box">
								...
								<div class="food-image">
									...
									<div class="price-bold">TK. 85</br><span class="meal">/meal</span></div>
								</div>
								<div class="price-btn-box">
									<ul>
										<li class="price-text"><a href="" data-toggle="modal" data-target="#menu85">Week Menu</a></li>
										<li>
											<div class="food-order-btn">
						...
						<!-- Modal -->
										<div id="menu85" class="modal fade" role="dialog">
											<div class="modal-dialog">
												<!-- Modal content-->
												<div class="modal-content full-menu-box">
													<div class="modal-header">
													...
													<div class="modal-body">
														<div class="full-menu-card">
															<div class="full-menu-head">
																Mr.</br>
																<span class="bold-text">Premium</span></br>
																<span class="menu-price">85tK</span>
															</div>
															<div class="full-menu-chart">
																<table class="table table-responsive full-menu-table">
																	<tr>
																		<th>শনিবার</th>
																		<td>সাদা ভাত + ডাল + সবজি/ ভর্তা + ডিম কারি + চিকেন কারি</td>
																	</tr>
																	<tr>
																		<th>রবিবার</th>
																		<td>সাদা ভাত + ডাল + সবজি/ ভর্তা +  লিভার মাসালা + ফিস কারি</td>
																	</tr>
																	<tr>
																		<th>সোমবার</th>
																		<td>শাহী সবজি খিচুড়ি + স্পেশাল চিকেন কারি + সালাদ</td>
																	</tr>
																	<tr>
																		<th>মঙ্গলবার</th>
																		<td>সাদা ভাত + ডাল + সবজি/ ভর্তা + স্পেশাল আলু গোশত</td>
																	</tr>
																	<tr>
																		<th>বুধবার</th>
																		<td>সাদা ভাত + ডাল + সবজি/ ভর্তা + স্পেশাল মুড়ি ঘন্ড + ফিস ফ্রাই</td>
																	</tr>
																	<tr>
																		<th>বৃহস্পতিবার</th>
																		<td>শাহী মোরগ পোলাও + ডিম কারি + সালাদ </td>
																	</tr>
																</table>
															</div>
															<div class="full-menu-order">
																<a class="order-now" href="form85.php">Order Now</a>
															</div>
														</div>
													</div>
												</div>
						...
						<div class="col-md-4 wow zoomIn" data-wow-duration="2s">
							<div class="single-order-box">
								...
								<div class="food-image">
									<img src="img/exc.jpg" alt="" />
									<div class="price-bold">TK. 100</br><span class="meal">/meal</span></div>
								</div>
								<div class="price-btn-box">
									<ul>
										<li class="price-text"><a href="" data-toggle="modal" data-target="#menu100">Week Menu</a></li>
										<li>
											<div class="food-order-btn">
											<?php
												if(isset($_SESSION['phone'])){
													echo"<a href='form95.php'>order Box</a>";
											}else{
												echo"<a href='login.php'>order Box</a>";
											}
						...
						<!-- Modal -->
						<div id="menu100" class="modal fade" role="dialog">
							<div class="modal-dialog">
								<!-- Modal content-->
								<div class="modal-content full-menu-box">
									<div class="modal-header">
									...
									<div class="modal-body">
										<div class="full-menu-card">
											<div class="full-menu-head">
												Mr.</br>
												<span class="bold-text">Exclusive</span></br>
												<span class="menu-price">100tK</span>
											</div>
											<div class="full-menu-chart">
												<table class="table table-responsive full-menu-table">
													<tr>
														<th>শনিবার</th>
														<td>সাদা ভাত + ডাল + সবজি/ ভর্তা + চিকেন কারি + স্পেশাল ডেসার্ট</td>
													</tr>
													<tr>
														<th>রবিবার</th>
														<td>সাদা ভাত + ডাল + সবজি/ ভর্তা + ফিস কারি + ফ্রুটস</td>
													</tr>
													<tr>
														<th>সোমবার</th>
														<td>সাদা ভাত  + সবজি/ ভর্তা + চনার ডাল + মেজবানি মাংস</td>
													</tr>
													<tr>
														<th>মঙ্গলবার</th>
														<td>শাহী সবজি খিচুড়ি + স্পেশাল চিকেন কারি + সালাদ + সফট ড্রিংকস</td>
													</tr>
													<tr>
														<th>বুধবার</th>
														<td>সাদা ভাত + ডাল + সবজি/ ভর্তা + স্পেশাল মুড়ি ঘন্ড + ফিস ফ্রাই + ডেসার্ট</td>
													</tr>
													<tr>
														<th>বৃহস্পতিবার</th>
														<td>শাহী মোরগ পোলাও + ডিম কারি + সালাদ + সফট ড্রিংকস </td>
													</tr>
												</table>
											</div>
											<div class="full-menu-order">
	...
	<h2><span class="spanbold">MR.FOOD</span> is easy like Counting <span class="wow fadeInUp" data-wow-delay="1s">1</span>.<span class="wow fadeInUp" data-wow-delay="2s">2</span>.<span class="wow fadeInUp" data-wow-delay="3s">3</span>...</span></h2>
		...
		<section class="order-box-head-area">
			...
			<div class="row">
					<div class="top-text-box wow bounceIn" data-wow-delay=".1s" data-wow-duration="2s">
						<div class="section-heading recipe">
							<div class="blog_heading blog-text">
								<h2>ENJOY DISCOUNT IN POPULAR RESTAURENTS</h2>
							</div>
						</div>
					</div>
				</div>
		...
		<section class="resturant-discount-area">
			<div class="container">
				<div class="row">
					<div class="col-md-3">
						<div class="signle-rest-dis-box">
							<div class="rest-img">
								<img src="img/rest-1.jpg" alt="" />
							</div>
							<div class="rest-header">
								<p><a href="">Global hair color any len ...</a></p>
								<p class="rest-time"><i class="fa fa-clock-o"></i> 12 days, 23 hours, 26 mins.</p>
							</div>
							<div class="rest-btn">
								<a href="">View Details</a>
							</div>
							<div class="res-bottom">
								<a href="">Fares Restaurant (1 offers)</a>
							</div>
						</div>
					</div><!--single rest box-->
					<div class="col-md-3">
